...
public interface TableConst {
	...
	String BLACK_LIST_TBL = "black_list";
	String CHK_REAL_TBL = "chk_real";
	String CHK_LOG_TBL = "chk_log";
	String RENTAL_TBL = "rental";
	...
	String SUGGEST_BOARD_TBL = "suggest_board";
	String NOTICE_BOARD_TBL = "notice_board";
	String INQUIRY_TBL = "inquiry";
